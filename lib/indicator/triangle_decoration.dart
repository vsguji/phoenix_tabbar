...
class TriangleIndicator extends Decoration {
  ...
  factory TriangleIndicator.fromBoxDecoration(BoxDecoration source) {
    ShapeBorder? shape;
    switch (source.shape) {
  ...
  @override
  TriangleIndicator? lerpTo(Decoration? b, double t) {
    if (b is BoxDecoration) {
      return TriangleIndicator.lerp(
          this, TriangleIndicator.fromBoxDecoration(b), t);
    } else if (b == null || b is TriangleIndicator) {
      return TriangleIndicator.lerp(this, b as TriangleIndicator?, t);
    }
    return super.lerpTo(b, t) as TriangleIndicator?;
  }

  static TriangleIndicator? lerp(
      TriangleIndicator? a, TriangleIndicator? b, double t) {
  ...
  bool operator ==(dynamic other) {
    ...
    final TriangleIndicator typedOther = other;
...
class _TriangleDecorationPainter extends BoxPainter {
  ...
  final TriangleIndicator _decoration;
