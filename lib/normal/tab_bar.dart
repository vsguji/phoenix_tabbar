...
/// 单个tab选中的回调
/// [state]:当前组件的State对象，[TabBarState]
/// [index]:当前组件的角标
typedef TabBarOnTap = Function(PhoenixTabBarState state, int index);
...
class PhoenixTabBar extends StatefulWidget {
  ...
  @override
  PhoenixTabBarState createState() => PhoenixTabBarState(closeController);
}
...
class PhoenixTabBarState extends State<PhoenixTabBar> {
  /// 小红点文案
  ...
  void initState() {
    super.initState();
    _brnTabbarController = PhoenixTabbarController();
    // 监听更多弹框tab选中变化的时候
...
class _TabBarOverlayWidget extends StatefulWidget {
  ...
  PhoenixTabbarController? brnTabbarController;
